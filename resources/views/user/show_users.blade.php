...
<div class="row"> 
    <div class="col-sm-12">
        ...
        <a href="" class="btn btn-success pull-right">Nuevo usuario</a>
        ...
        <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
            ...
            <thead>            
                <tr>
                    @foreach($CAMPOS_USUARIOS as $key => $value)            
                ...
                @foreach($usuarios as $usuario)
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-4">
                                <a href="{{ route('usuario.show', $usuario->cedula) }}" class="btn btn-link"><i class="fa fa-eye"></i></a>
